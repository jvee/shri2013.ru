...
}b.trigger&&this.loadUrl(a)}},_updateHash:function(a,b,c){if(c){var d=a.href.replace(/(javascript:|#).*$/,"");a.replace(d+"#"+b)}else a.hash="#"+b}}),a.history=new E;var J=function(a,b){var c,d=this;c=a&&h.has(a,"constructor")?a.constructor:function(){return d.apply(this,arguments)},h.extend(c,d,b);var e=function(){this.constructor=c};return e.prototype=d.prototype,c.prototype=new e,a&&h.extend(c.prototype,a),c.__super__=d.prototype,c};n.extend=q.extend=z.extend=v.extend=E.extend=J;var K=function(){throw new Error('A "url" property or function must be specified')},L=function(a,b){var c=b.error;b.error=function(d){c&&c(a,d,b),a.trigger("error",a,d,b)}}}.call(this),function(a,b,c){"use strict";c.LectureModel=Backbone.Model.extend({defaults:{title:"",lecturer:"",description:"",presentationUrl:"",videoUrl:""}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.MenuItemModel=Backbone.Model.extend({defaults:{index:0,title:"",url:"/",type:"StaticView",active:!1}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.PersonModel=Backbone.Model.extend({defaults:{name:"",photo:"",about:"",profiles:{}}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.StaticModel=Backbone.Model}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.LectureCollection=Backbone.Collection.extend({model:c.LectureModel,comparator:"title"})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.MenuCollection=Backbone.Collection.extend({model:c.MenuItemModel,comparator:"index"})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.PersonCollection=Backbone.Collection.extend({model:c.PersonModel,comparator:"name"})}(this,jQuery,App=window.App||{},void 0),App.templates=function(){function a(){var a={"&":"&#38;","<":"&#60;",">":"&#62;",'"':"&#34;","'":"&#39;","/":"&#47;"},b=/&(?!#?w+;)|<|>|"|'|\//g;return function(){return this?this.replace(b,function(b){return a[b]||b}):this}}String.prototype.encodeHTML=a();var b={};return b.AppTemplate=function(){var a='<div class="b-header"></div><div class="b-page"></div>';return a},b.LectureTemplate=function(a){var b='<div class="b-lecture__title b-block__title"><h2 class="b-lecture__header b-block__header">'+a.title+"</h2>";return(a.videoUrl||a.presentationUrl)&&(b+='<ul class="b-lecture__links-list b-block__link-list">',a.presentationUrl&&(b+='<li class="b-lecture__link b-lecture__link_type_presentation b-block__link-item"><a href="'+a.presentationUrl+'">Презентация</a></li>'),a.videoUrl&&(b+='<li class="b-lecture__link b-lecture__link_type_video b-block__link-item"><a href="'+a.videoUrl+'">Видео</a></li>'),b+="</ul>"),a.lecturer&&(b+='<h3 class="b-lecture__lecturer b-block__subheader">'+a.lecturer+"</h3>"),b+='</div><div class="b-block__content b-text">',a.description&&(b+=a.description),b+="</div>"},b.MenuItemTemplate=function(a){var b='<a class="b-menu-item__link';return a.active&&(b+=" is-active"),b+='" href="'+a.url+'">'+a.title+"</a>"},b.PersonTemplate=function(a){var b='<div class="b-person__title b-block__title"><h2 class="b-block__header">'+a.name+'</h2><a href="#students/'+a.name+'" class="b-block__linker"></a>';if(a.profiles){b+='<ul class="b-person__link-list b-block__link-list">';var c=a.profiles;if(c)for(var d,e=-1,f=c.length-1;f>e;)d=c[e+=1],b+='<li class="b-person__link-item b-person__link-item_type_'+d.name.toLowerCase()+' b-block__link-item"><a href="'+d.link+'">'+d.name+"</a></li>";b+="</ul>"}return b+='</div><div class="b-block__content">',a.photo&&(b+='<img class="b-person__photo" src="'+a.photo+'" alt="'+a.name+'">'),b+='<div class="b-person__about b-text">'+a.about+"</div></div>"},b}(),function(a,b,c){"use strict";c.AppView=Backbone.View.extend({el:document.body,template:c.templates.AppTemplate,initialize:function(a){this.menu=new c.MenuCollection(a.data.menu||[]),this.menuView=new c.MenuView({collection:this.menu}),this.pages={},this.parsePages(a.data.pages),this.bindEvents(),this.render(),this.$headerEl=this.$(".b-header"),this.headerEl=this.$headerEl[0],this.headerEl.appendChild(this.menuView.render().el),this.$pageEl=this.$(".b-page"),this.pageEl=this.$pageEl[0]},bindEvents:function(){c.vents&&c.vents.on("app.route",this.renderPage,this)},parsePages:function(a){var b;for(b=0;b<a.length;b++)this.pages[a[b].url]=new c[a[b].type](a[b].data)},render:function(){return this.el.innerHTML=this.template(),this},renderPage:function(a){var b,d,e,f;"string"==typeof a&&(a=this.menu.where({url:a})[0]),b=a.get("url"),d=a.get("type"),e=new c[d],f=this.pages[b],f instanceof Backbone.Model&&(e.model=f),f instanceof Backbone.Collection&&(e.collection=f),this.currentPageView&&this.currentPageView.remove(),this.currentPageView=e,this.pageEl.appendChild(e.render().el)}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.LectureListView=Backbone.View.extend({tagName:"section",className:"b-lecture-list",render:function(){return this.collection.each(this.addLecture,this),this},addLecture:function(a){var b=new c.LectureView({model:a});return this.el.appendChild(b.render().el),this}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.LectureView=Backbone.View.extend({tagName:"article",className:"b-lecture b-block",template:c.templates.LectureTemplate,render:function(){return this.el.innerHTML=this.template(this.model.toJSON()),this}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.MenuItemView=Backbone.View.extend({tagName:"li",className:"b-menu-item",template:c.templates.MenuItemTemplate,events:{"click .b-menu-item__link":"setActive"},initialize:function(){this.model.on("change",this.render,this),c.vents&&c.vents.on("app.route",this.toggleActive,this)},render:function(){return this.el.innerHTML=this.template(this.model.toJSON()),this},toggleActive:function(a){this.model.get("url")===a?this.model.set("active",!0):this.model.set("active",!1)},setActive:function(a){a&&a.preventDefault();var b=this.model.get("active");b||(c.vents&&c.vents.trigger("app.navigate",this.model.get("url"),{trigger:!0}),this.model.set("active",!0))}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.MenuView=Backbone.View.extend({tagName:"ul",className:"b-menu",render:function(){return this.collection.each(this.addItem,this),this},addItem:function(a){var b=new c.MenuItemView({model:a});return this.el.appendChild(b.render().el),this}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.PersonListView=Backbone.View.extend({tagName:"section",className:"b-person-list",initialize:function(){c.vents&&c.vents.on("app.student",this.showOne,this)},render:function(){return this.collection.each(this.addPerson,this),this},addPerson:function(a){var b=new c.PersonView({model:a});return this.el.appendChild(b.render().el),this},showOne:function(a){var b=this.collection.findWhere({name:a});return console.log(a,b),this.el.innerHTML="",b?(this.addPerson(b),this):this}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.PersonView=Backbone.View.extend({tagName:"article",className:"b-person b-block",template:c.templates.PersonTemplate,render:function(){return this.el.innerHTML=this.template(this.model.toJSON()),this}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){c.StaticView=Backbone.View.extend({tagName:"article",className:"b-static b-text b-block",render:function(){return this.el.innerHTML=this.model.get("content"),this}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){c.Router=Backbone.Router.extend({routes:{"":"index","students/":"students","students/:name":"students","lectures/":"lectures"},initialize:function(){c.vents.on("app.navigate",this.navigate,this)},index:function(){c.vents.trigger("app.route","/")},students:function(a){c.vents.trigger("app.route","/students/"),a&&c.vents.trigger("app.student",a)},lectures:function(){c.vents.trigger("app.route","/lectures/")}}),c.vents=_.extend({},Backbone.Events),c.app=new c.AppView({data:c.data,el:document.getElementById("app")}),c.router=new c.Router,Backbone.history.start({pushState:!1})}(this,jQuery,App=window.App||{},void 0);