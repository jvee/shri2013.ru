...
}b.trigger&&this.loadUrl(a)}},_updateHash:function(a,b,c){if(c){var d=a.href.replace(/(javascript:|#).*$/,"");a.replace(d+"#"+b)}else a.hash="#"+b}}),a.history=new E;var J=function(a,b){var c,d=this;c=a&&h.has(a,"constructor")?a.constructor:function(){return d.apply(this,arguments)},h.extend(c,d,b);var e=function(){this.constructor=c};return e.prototype=d.prototype,c.prototype=new e,a&&h.extend(c.prototype,a),c.__super__=d.prototype,c};n.extend=q.extend=z.extend=v.extend=E.extend=J;var K=function(){throw new Error('A "url" property or function must be specified')},L=function(a,b){var c=b.error;b.error=function(d){c&&c(a,d,b),a.trigger("error",a,d,b)}}}.call(this),function(a,b){"object"==typeof exports&&"function"==typeof require?module.exports=b(require("underscore"),require("backbone")):"function"==typeof define&&define.amd?define(["underscore","backbone"],function(c,d){return b(c||a._,d||a.Backbone)}):b(_,Backbone)}(this,function(a,b){function c(){return(0|65536*(1+Math.random())).toString(16).substring(1)}function d(){return c()+c()+"-"+c()+"-"+c()+"-"+c()+"-"+c()+c()+c()}return b.LocalStorage=window.Store=function(a){if(!this.localStorage)throw"Backbone.localStorage: Environment does not support localStorage.";this.name=a;var b=this.localStorage().getItem(this.name);this.records=b&&b.split(",")||[]},a.extend(b.LocalStorage.prototype,{save:function(){this.localStorage().setItem(this.name,this.records.join(","))},create:function(a){return a.id||(a.id=d(),a.set(a.idAttribute,a.id)),this.localStorage().setItem(this.name+"-"+a.id,JSON.stringify(a)),this.records.push(a.id.toString()),this.save(),this.find(a)},update:function(b){return this.localStorage().setItem(this.name+"-"+b.id,JSON.stringify(b)),a.include(this.records,b.id.toString())||this.records.push(b.id.toString()),this.save(),this.find(b)},find:function(a){return this.jsonData(this.localStorage().getItem(this.name+"-"+a.id))},findAll:function(){return(a.chain||a)(this.records).map(function(a){return this.jsonData(this.localStorage().getItem(this.name+"-"+a))},this).compact().value()},destroy:function(b){return b.isNew()?!1:(this.localStorage().removeItem(this.name+"-"+b.id),this.records=a.reject(this.records,function(a){return a===b.id.toString()}),this.save(),b)},localStorage:function(){return localStorage},jsonData:function(a){return a&&JSON.parse(a)},_clear:function(){var b=this.localStorage(),c=new RegExp("^"+this.name+"-");b.removeItem(this.name),(a.chain||a)(b).keys().filter(function(a){return c.test(a)}).each(function(a){b.removeItem(a)}),this.records.length=0},_storageSize:function(){return this.localStorage().length}}),b.LocalStorage.sync=window.Store.sync=b.localSync=function(a,c,d){var e,f,g=c.localStorage||c.collection.localStorage,h=b.$.Deferred&&b.$.Deferred();try{switch(a){case"read":e=void 0!=c.id?g.find(c):g.findAll();break;case"create":e=g.create(c);break;case"update":e=g.update(c);break;case"delete":e=g.destroy(c)}}catch(i){f=22===i.code&&0===g._storageSize()?"Private browsing is unsupported":i.message}return e?(d&&d.success&&("0.9.10"===b.VERSION?d.success(c,e,d):d.success(e)),h&&h.resolve(e)):(f=f?f:"Record Not Found",d&&d.error&&("0.9.10"===b.VERSION?d.error(c,f,d):d.error(f)),h&&h.reject(f)),d&&d.complete&&d.complete(e),h&&h.promise()},b.ajaxSync=b.sync,b.getSyncMethod=function(a){return a.localStorage||a.collection&&a.collection.localStorage?b.localSync:b.ajaxSync},b.sync=function(a,c,d){return b.getSyncMethod(c).apply(this,[a,c,d])},b.LocalStorage}),function(a,b,c){"use strict";c.LectureModel=Backbone.Model.extend({defaults:{title:"",lecturer:"",description:"",presentationUrl:"",videoUrl:""},idAttribute:"title",initialize:function(a,b){b&&!b.merge&&b.collection.localStorage&&this.save()}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.MenuItemModel=Backbone.Model.extend({defaults:{index:0,title:"",url:"/",type:"StaticView",active:!1}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.PersonModel=Backbone.Model.extend({defaults:{name:"",photo:"",about:"",profiles:{}},initialize:function(a,b){a&&a.name&&(this.id=this.get("name").replace(/\s/g,"_")),b&&!b.merge&&b.collection.localStorage&&this.save()}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.StaticModel=Backbone.Model.extend({initialize:function(a,c){this.localStorage=c.localStorage,this.id=this.localStorage.name,a?this.save():this.set("content",b.parseJSON(localStorage[this.id+"-"+this.id]))}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.LectureCollection=Backbone.Collection.extend({model:c.LectureModel,comparator:"title",initialize:function(a,b){this.localStorage=b&&b.localStorage}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.MenuCollection=Backbone.Collection.extend({model:c.MenuItemModel,comparator:"index"})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.PersonCollection=Backbone.Collection.extend({model:c.PersonModel,comparator:"name",initialize:function(a,b){this.localStorage=b&&b.localStorage}})}(this,jQuery,App=window.App||{},void 0),App.templates=function(){function a(){var a={"&":"&#38;","<":"&#60;",">":"&#62;",'"':"&#34;","'":"&#39;","/":"&#47;"},b=/&(?!#?w+;)|<|>|"|'|\//g;return function(){return this?this.replace(b,function(b){return a[b]||b}):this}}String.prototype.encodeHTML=a();var b={};return b.AppTemplate=function(){var a='<div class="b-header"></div><div class="b-page"></div>';return a},b.LectureTemplate=function(a){var b='<div class="b-lecture__title b-block__title"><h2 class="b-lecture__header b-block__header">'+a.title+"</h2>";return(a.videoUrl||a.presentationUrl)&&(b+='<ul class="b-lecture__links-list b-block__link-list">',a.presentationUrl&&(b+='<li class="b-lecture__link b-lecture__link_type_presentation b-block__link-item"><a href="'+a.presentationUrl+'">Презентация</a></li>'),a.videoUrl&&(b+='<li class="b-lecture__link b-lecture__link_type_video b-block__link-item"><a href="'+a.videoUrl+'">Видео</a></li>'),b+="</ul>"),a.lecturer&&(b+='<h3 class="b-lecture__lecturer b-block__subheader">'+a.lecturer+"</h3>"),b+='</div><div class="b-block__content b-text">',a.description&&(b+=a.description),b+="</div>"},b.MenuItemTemplate=function(a){var b='<a class="b-menu-item__link';return a.active&&(b+=" is-active"),b+='" href="'+a.url+'">'+a.title+"</a>"},b.PersonListItemTemplate=function(a){var b='<a href="#!/students/'+a.id+'" class="b-person-li__wrap" style="background-image:url('+a.photo+')"></a><a href="#!/students/'+a.id+'" class="b-person-li__name">'+a.name+"</a>";return b},b.PersonTemplate=function(a){var b='<div class="b-person__title b-block__title"><h2 class="b-block__header">'+a.name+'</h2><a href="#!/students/'+a.id+'" class="b-block__linker"></a>';if(a.profiles){b+='<ul class="b-person__link-list b-block__link-list">';var c=a.profiles;if(c)for(var d,e=-1,f=c.length-1;f>e;)d=c[e+=1],b+='<li class="b-person__link-item b-person__link-item_type_'+d.name.toLowerCase()+' b-block__link-item"><a href="'+d.link+'">'+d.name+"</a></li>";b+="</ul>"}return b+='</div><div class="b-block__content">',a.photo&&(b+='<img class="b-person__photo" src="'+a.photo+'" alt="'+a.name+'">'),b+='<div class="b-person__about b-text">'+a.about+"</div></div>"},b.PopupTemplate=function(){var a='<div class="b-popup__block"><div class="b-popup__close">&times;</div><div class="b-popup__wrap"><div class="b-popup__content"></div></div></div>';return a},b}(),function(a,b,c){"use strict";c.AppView=Backbone.View.extend({el:document.body,template:c.templates.AppTemplate,initialize:function(a){this.menu=new c.MenuCollection(a.data.menu||[]),this.menuView=new c.MenuView({collection:this.menu}),this.popup=new c.PopupView,this.pages={},this.parsePages(a.data.pages),this.bindEvents(),this.render(),this.$headerEl=this.$(".b-header"),this.headerEl=this.$headerEl[0],this.headerEl.appendChild(this.menuView.render().el),this.$pageEl=this.$(".b-page"),this.pageEl=this.$pageEl[0]},bindEvents:function(){c.vents&&(c.vents.on("app.route",this.renderPage,this),c.vents.on("app.popup:show",function(){this.$el.addClass("is-popupped")},this),c.vents.on("app.popup:close",function(){this.$el.removeClass("is-popupped")},this))},parsePages:function(a){var b,d;for(b=0;b<a.length;b++)d=new c[a[b].type](a[b].data,{localStorage:new Backbone.LocalStorage(a[b].url)}),this.pages[a[b].url]=d,d.fetch()},render:function(){return this.el.innerHTML=this.template(),this},renderPage:function(a,b){var d,e,f,g;"string"==typeof a&&(a=this.menu.where({url:a})[0]),d=a.get("url"),e=a.get("type"),f=new c[e],g=this.pages[d],g instanceof Backbone.Model&&(f.model=g),g instanceof Backbone.Collection&&(f.collection=g),this.currentPageView&&this.currentPageView.remove(),this.currentPageView=f,this.pageEl.appendChild(f.render(b,d).el)}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.LectureListView=Backbone.View.extend({tagName:"section",className:"b-lecture-list",render:function(){return this.collection.each(this.addLecture,this),this},addLecture:function(a){var b=new c.LectureView({model:a});return this.el.appendChild(b.render().el),this}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.LectureView=Backbone.View.extend({tagName:"article",className:"b-lecture b-block",template:c.templates.LectureTemplate,render:function(){return this.el.innerHTML=this.template(this.model.toJSON()),this}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.MenuItemView=Backbone.View.extend({tagName:"li",className:"b-menu-item",template:c.templates.MenuItemTemplate,events:{"click .b-menu-item__link":"setActive"},initialize:function(){this.model.on("change",this.render,this),c.vents&&c.vents.on("app.route",this.toggleActive,this)},render:function(){return this.el.innerHTML=this.template(this.model.toJSON()),this},toggleActive:function(a){this.model.get("url")===a?this.model.set("active",!0):this.model.set("active",!1)},setActive:function(a){a&&a.preventDefault(),c.vents&&c.vents.trigger("app.navigate","!"+this.model.get("url"),{trigger:!0}),this.model.set("active",!0)}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.MenuView=Backbone.View.extend({tagName:"ul",className:"b-menu",render:function(){return this.collection.each(this.addItem,this),this},addItem:function(a){var b=new c.MenuItemView({model:a});return this.el.appendChild(b.render().el),this}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.PersonListItemView=Backbone.View.extend({tagName:"div",className:"b-person-li b-block",template:c.templates.PersonListItemTemplate,render:function(){var a=b.extend({id:this.model.id},this.model.toJSON());return this.el.innerHTML=this.template(a),this}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.PersonListView=Backbone.View.extend({tagName:"section",className:"b-person-list",render:function(a,b){return this.collection.each(this.addOne,this),a&&this.showOne(a,b),this},addOne:function(a){var b=new c.PersonListItemView({model:a});return this.el.appendChild(b.render().el),this},showOne:function(a,b){var d=new c.PersonView({model:this.collection.get(a)});c.vents&&c.vents.trigger("app.popup",d,b)}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.PersonView=Backbone.View.extend({tagName:"article",className:"b-person b-block",template:c.templates.PersonTemplate,render:function(){var a=b.extend({id:this.model.id},this.model.toJSON());return this.el.innerHTML=this.template(a),this}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){"use strict";c.PopupView=Backbone.View.extend({className:"b-popup",template:c.templates.PopupTemplate,events:{"click .b-popup__close":"close",click:"close","click .b-popup__wrap":"preventClose"},initialize:function(){this.render(),this.state="hidden",this.contentEl=this.$(".b-popup__content")[0],c.vents&&c.vents.on("app.popup",this.show,this)},render:function(){this.el.innerHTML=this.template(),document.body.appendChild(this.el)},show:function(a,b){var d=this;return a?(this.nestedView=a,this.backUrl=b,this.contentEl.appendChild(a.render().el),"hidden"===this.state&&(this.el.style.display="block",setTimeout(function(){d.$el.addClass("is-visible")},0),this.state="visible"),c.vents&&c.vents.trigger("app.popup:show",this),this):this},close:function(a){var b=this;return a&&a.stopPropagation(),this.nestedView&&"hidden"!==this.state?(this.$el.removeClass("is-visible"),c.vents&&(c.vents.trigger("app.navigate","!"+this.backUrl),c.vents.trigger("app.popup:close",this)),setTimeout(function(){b.nestedView.remove(),b.nestedView=void 0,b.backUrl=void 0,b.el.style.display="none",b.state="hidden"},300),this):this},preventClose:function(a){a&&a.stopPropagation()}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){c.StaticView=Backbone.View.extend({tagName:"article",className:"b-static b-text b-block",render:function(){return this.el.innerHTML=this.model.get("content"),this}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){var d,e,f=localStorage.version,g=document.getElementsByTagName("head")[0],h=document.createElement("style");f&&f===c.version?(h.innerHTML=localStorage.css,c.data=b.parseJSON(localStorage["app.data"])):(b.get(c.stylesLink).then(function(a){h.innerHTML=a,localStorage.css=a}),b.ajax(c.dataLink,{async:!1,complete:function(a){for(c.data=b.parseJSON(a.responseText),d=b.extend(!0,{},c.data),e=0;e<d.pages.length;e++)d.pages[e].data=void 0;localStorage["app.data"]=JSON.stringify(d)}})),g.appendChild(h),localStorage.version=c.version}(this,jQuery,App=window.App||{},void 0),function(a,b,c){c.Router=Backbone.Router.extend({routes:{"(!/)":"index","(!/)students(/)":"students","(!/)students/:name":"students","(!/)lectures(/)":"lectures"},initialize:function(){c.vents.on("app.navigate",this.navigate,this)},index:function(){c.vents.trigger("app.route","/")},students:function(a){c.vents.trigger("app.route","/students/",a)},lectures:function(){c.vents.trigger("app.route","/lectures/")}})}(this,jQuery,App=window.App||{},void 0),function(a,b,c){c.vents=_.extend({},Backbone.Events),c.app=new c.AppView({data:c.data,el:document.getElementById("app")}),c.router=new c.Router,Backbone.history.start({pushState:!1})}(this,jQuery,App=window.App||{},void 0);